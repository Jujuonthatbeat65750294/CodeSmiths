...
class Game extends Component {
  constructor(props) {
    ...
    this.state = {
      rounds: [
        {
          soundUrl: 'https://jolly2.s3.amazonaws.com/british_english/group1/a.mp3',
          options: [
            ...
            { label: 'Ant', imageUrl: 'https://t4.ftcdn.net/jpg/00/90/98/53/360_F_90985363_MVFx1czghxJechCp7HM85bKJv1vUQN2c.jpg' },
          ],
          correctAnswer: 'Ant',
     },
        {
          ...
          options: [
            { label: 'Dog', imageUrl: 'https://images.saymedia-content.com/.image/t_share/MTc0MjU0ODc2MjYyNDc1NjQ0/drawing-a-cartoon-dog.jpg'},
            { label: 'Tooth', imageUrl: 'https://t3.ftcdn.net/jpg/00/80/59/96/360_F_80599666_qaCh2HsJaZGqUCN1m2Uu1CrgRdByxAue.jpg' },
  ...
  handleOptionClick = (option) => {
    ...
    if (option === rounds[currentRound].correctAnswer) {
     ...
     const winAudio = new Audio('../../../assets/audio/wrong answer.mp3');
     const volume = 0.8;
     winAudio.volume = volume;
     winAudio.play();
    }
  ...
  render() {
    ...
    return (
      ...
      <audio src='../../../assets/audio/playPaysage.mp3' autoPlay/>
